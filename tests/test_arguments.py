...
class TestArguments:
    def test_add_dns_record_arguments(self):
        ...
        options = args.validate_arguments(
            args.parse_arguments(
                ['-c', 'config.yaml', '-o', 'add-dns-record', '-n' 'test.example.com', '-i', '192.168.1.1']
            )
        )
    ...
    def test_delete_dns_record_arguments(self):
        ...
        options = args.validate_arguments(
            args.parse_arguments(
                ['-c', 'config.yaml', '-o', 'delete-dns-record', '-n' 'test.example.com', '-i', '192.168.1.1']
            )
        )
    ...
    def test_check_record_sync_arguments(self):
        ...
        options = args.validate_arguments(
            args.parse_arguments(
                ['-c', 'config.yaml', '-o', 'check-record-sync', '-n' 'test.example.com', '-i', '192.168.1.1']
            )
        )
    ...
    def test_update_gravity_arguments(self):
        ...
        options = args.validate_arguments(
            args.parse_arguments(
                ['-c', 'config.yaml', '-o', 'update-gravity']
            )
        )
