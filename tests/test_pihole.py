...
class TestPiHole:
    ...
    def test_ip_validation_edge_cases(self):
        ...
        """
        valid_ips = [
            "0.0.0.0", "255.255.255.255", "192.168.1.0", "192.168.1.255"
        ]
        invalid_ips = [
            "256.0.0.0", "192.168.1.256", "-1.-1.-1.-1", "192.168", "192,168,1,1"
        ]
    ...
    def test_hostname_validation_edge_cases(self):
        ...
        """
        valid_hostnames = [
            "example.com", "sub.domain.co.uk", "a.b.c.d.e.f.g.h.i.j.k.l.example.com"
        ]
        invalid_hostnames = [
            "example!com", "domain@.com", "-example.com", "example-.com"
        ]
    ...
    def test_paramiko_client_creation_success(self, pi_hole_instance):
        ...
        with patch('paramiko.SSHClient') as mock_ssh:
            ...
            mock_instance.exec_command.return_value = (MagicMock(), MagicMock(), MagicMock())        
            test_client = pi_hole_instance._create_ph_client()
            
            mock_ssh.assert_called_once()
            mock_instance.set_missing_host_key_policy.assert_called_once()
            mock_instance.connect.assert_called_once_with(pi_hole_instance.hostname, pi_hole_instance.port, pi_hole_instance.username, key_filename=pi_hole_instance.key_file)
    ...
    def test_ip_exists_in_dns(self, pi_hole_instance, mocker):
        ...
        """
        mocker.patch.object(pi_hole_instance, '_execute', return_value={'output': '1\n'})
    ...
    def test_ip_does_not_exist_in_dns(self, pi_hole_instance, mocker):
        ...
        Args:
            ...
            mocker (_type_): _description_
        """
        mocker.patch.object(pi_hole_instance, '_execute', return_value={'output': '0\n'})
        mocker.patch.object(pi_hole_instance.validator, 'validate', return_value=True)
    ...
    def test_unexpected_ssh_output(self, pi_hole_instance, mocker):
        ...
        Args:
            ...
            mocker (_type_): _description_
        """
        mocker.patch.object(pi_hole_instance, '_execute', return_value={'output': 'unexpected output'})
        mocker.patch.object(pi_hole_instance.validator, 'validate', return_value=True)
